...
export const serviceFaqs = [
  {
    q: "01. Where are you based out of?",
    a: "We are based out of Delhi and are available for meetings by appointment.",
  },
  {
    q: "02. Do you provide turn-key solutions?",
    a: "No, we provide design services. Our scope covers the design and documentation required to take the project forward.",
  },
  {
    q: "03. Is your service available pan India?",
    a: "Yes, we provide interior design consultation pan India.",
  },
  {
    q: "04. Do you visit the site?",
    a: "Yes, we do visit the site as per requirements. Charges vary from project to project.",
  },
  {
    q: "05. Can I get 2–3 options for the design?",
  ...
  {
    q: "06. Can I get only 3D views?",
    a: "3D views are the final output of the design and cannot be provided separately. We do provide 3D views as a part of our complete service.",
  },
  {
    q: "07. How much time will it take for designing?",
    a: "The timeframe is between 20–40 days depending on the scope of work.",
  },
];
