                  ...
                  <div className="grid gap-5 sm:grid-cols-[9rem_1fr]">
                    {visual && (
                      <div className="overflow-hidden border border-border">
                        <img src={mediaPreviewUrl(visual.src, 360)} alt="" loading="lazy" decoding="async" className="aspect-[4/3] h-full w-full object-cover transition-transform duration-700 group-hover:scale-105 sm:aspect-auto" />
                      </div>
                    )}
